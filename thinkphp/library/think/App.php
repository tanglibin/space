...
class App
{
    ...
    public static function module($result, $config, $convert = null)
    {
        ...
        if ($config['app_multi_module']) {
            ...
            //请求地址除了地址栏 中的tlbgl 或 ajax中的 action，其他的都做跳转到首页处理
            $current_module = array('tlbgl');
            if(is_from_ajax()){
            	//来自ajax的请求，module只能是action， 其他则为请求错误
            	if($module != 'action'){
                    return ['status' => false, 'msg' => '指定action不存在'];
            	}
            	array_push($current_module, 'action');
            }
